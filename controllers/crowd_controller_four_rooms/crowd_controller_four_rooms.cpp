...
#include "CrowdManager_four_rooms.cpp"
#include <string>

#define TIME_STEP 32
#define DEBUG 0

class CrowdAgent_Four_Rooms : public webots::Supervisor {
public:

    CrowdAgent_Four_Rooms() {
        ...
        CrowdManager_Four_Rooms& manager = CrowdManager_Four_Rooms::getInstance(*this);
...
int main() {
    CrowdAgent_Four_Rooms* agent = new CrowdAgent_Four_Rooms();
