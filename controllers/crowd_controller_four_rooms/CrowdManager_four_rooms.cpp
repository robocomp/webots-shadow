...
class CrowdManager_Four_Rooms {
public:

    // Método para obtener la instancia Singleton.
    static CrowdManager_Four_Rooms& getInstance(webots::Supervisor& supervisor) {
        static CrowdManager_Four_Rooms instance(supervisor);
        return instance;
    }
...
private:
    ...
    CrowdManager_Four_Rooms(webots::Supervisor& supervisor) {
        initializeWaypoints(supervisor);
        initializeGraphConnections();
    }

    // Evitar que se pueda copiar el objeto.
    CrowdManager_Four_Rooms(CrowdManager_Four_Rooms const&) = delete;
    void operator=(CrowdManager_Four_Rooms const&) = delete;
    ...
    void initializeGraphConnections() {
        ...
        addConnection("WAYPOINT_4", "WAYPOINT_1");
    }
